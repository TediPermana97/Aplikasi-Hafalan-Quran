                ...
                <div class="modal-dialog modal-simple">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      if ($cek==0) {
                       ?>
                       <p>Anda belum dapat memulai pengisian checklist. Silahkan mengisi daftar checklist terlebih dahulu <a href="<?php echo base_url()?>index.php/user/jenis_cacat/">Disini</a></p>
                       <?php
                     }else if ($cek!=0) {
                       ?>
  ...
  <div class="panel">
      ...
      <div class="panel">
        <header class="panel-heading">
          ...
          <h3 class="panel-title">Pareto Chart Data</h3>
        </header>
        <div class="panel-body">
                  ...
                  <tr>
                    ...
                    foreach ($distinct_record as $dr) {
                      ?>
                        <th>
                          <?php
                            if (strlen($dr['tanggal'])==1) {
                              echo "0".$dr['tanggal']."-";
                            }else{
                              echo $dr['tanggal']."-";
                            }
                            if (strlen($dr['bulan'])==1) {
                              echo "0".$dr['bulan']."-";
                            }else{
                              echo $dr['bulan']."-";
                            } echo $dr['tahun'];
