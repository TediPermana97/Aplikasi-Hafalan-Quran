package com.ngajicoding.tedipermana.Profile.MyProfileUstad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotohome = new Intent(MyProfileActivity.this,Home_UstadActivity.class);
        ...
        btn_keluar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //berpindah activity
                Intent gotosigin = new Intent(MyProfileActivity.this,LoginUstadActivity.class);
