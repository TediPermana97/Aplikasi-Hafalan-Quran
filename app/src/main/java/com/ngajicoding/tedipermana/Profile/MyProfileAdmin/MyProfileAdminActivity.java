package com.ngajicoding.tedipermana.Profile.MyProfileAdmin;
...
import com.ngajicoding.tedipermana.Profile.MyProfileSantri.EditProfileSantriActivity;
import com.ngajicoding.tedipermana.Profile.MyProfileSantri.MyProfileSantriActivity;
import com.ngajicoding.tedipermana.R;
import com.squareup.picasso.Picasso;

public class MyProfileAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(MyProfileAdminActivity.this)
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotohome = new Intent(MyProfileAdminActivity.this,HomeUserActivity.class);
        ...
        btn_editprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotoeditprofil= new Intent(MyProfileAdminActivity.this,EditProfileSantriActivity.class);
        ...
        btn_keluar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //berpindah activity
                Intent gotosigin = new Intent(MyProfileAdminActivity.this,LoginAdminActivity.class);
