...
public class EditProfileSantriActivity extends AppCompatActivity {
    ...
    Button button_save, btn_add_new_photo;
    LinearLayout btn_back;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_profile_santri);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(EditProfileSantriActivity.this)
                ...
                if (photo_location != null){
                    ...
                    storageReference.putFile(photo_location)
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            Intent gotoProfile = new Intent(EditProfileSantriActivity.this, MyProfileSantriActivity.class);
