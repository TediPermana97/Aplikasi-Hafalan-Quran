...
public class LoginUstadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_ustad);
        ...
        btn_new_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoregisterone = new Intent(LoginUstadActivity.this,RegisterUstadOneActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()){
                            ...
                            if(password.equals(passwordFromFirebase)){
                                ...
                                //berpindah activity
                                Intent gotohome = new Intent(LoginUstadActivity.this,Home_UstadActivity.class);
