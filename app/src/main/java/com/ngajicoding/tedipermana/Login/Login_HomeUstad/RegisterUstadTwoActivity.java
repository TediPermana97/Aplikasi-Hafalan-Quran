package com.ngajicoding.tedipermana.Login.Login_HomeUstad;
...
public class RegisterUstadTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_ustad_two);
                ...
                filePath.putFile(photo_location).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                                    ...
                                    reference.child("url_profil_poto").setValue(downloadUrl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                Toast.makeText(RegisterUstadTwoActivity.this,"Your picture Saved successfully",Toast.LENGTH_SHORT) .show();
                                                Intent gotomyprofil = new Intent(RegisterUstadTwoActivity.this,Home_UstadActivity.class);
                                                startActivity(gotomyprofil);
                                            }else{
                                                Toast.makeText(RegisterUstadTwoActivity.this,"Problem occurred while tryng to save your picture..",Toast.LENGTH_SHORT) .show();
                                            }
                                        }
                                    });
                                }
                            ...
                            Toast.makeText(RegisterUstadTwoActivity.this,"Your picture did NOT saved",Toast.LENGTH_SHORT) .show();
                            //progressDialog.dismiss();
                        }
                    }
                });
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoback = new Intent(RegisterUstadTwoActivity.this,RegisterUstadOneActivity.class);
