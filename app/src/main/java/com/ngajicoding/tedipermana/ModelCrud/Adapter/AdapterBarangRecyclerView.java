package com.ngajicoding.tedipermana.ModelCrud.Adapter;
...
import com.ngajicoding.tedipermana.ModelCrud.FirebaseDBCreateActivity;
import com.ngajicoding.tedipermana.ModelCrud.FirebaseDBReadActivity;
import com.ngajicoding.tedipermana.ModelCrud.Model.Barang;
...
public class AdapterBarangRecyclerView extends RecyclerView.Adapter<AdapterBarangRecyclerView.ViewHolder> {
    ...
    public AdapterBarangRecyclerView(ArrayList<Barang> barangs, Context ctx){
        ...
        context = ctx;
        FirebaseDBReadActivity listener = (FirebaseDBReadActivity) ctx;
    }
                ...
                delButton.setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                 ...
                                 */
                                dialog.dismiss();
                                FirebaseDataListener listener = null;
