package com.ngajicoding.tedipermana.Dasboard.HomeAdmin;
...
import com.ngajicoding.tedipermana.Profile.MyProfileAdmin.MyProfileAdminActivity;
...
public class Home_AdminActivity extends AppCompatActivity {
    ...
    public void onClickProfil(View v){
        Intent i = new Intent(this,MyProfileAdminActivity.class);
