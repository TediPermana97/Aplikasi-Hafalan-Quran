package com.ngajicoding.tedipermana.Dasboard.HomeUser;
...
import com.ngajicoding.tedipermana.Edukasi.EdukasiActivity;
...
public class HomeUserActivity extends AppCompatActivity {
    ...
    public void onClickProfil(View v){
        Intent i = new Intent(this,MyProfileSantriActivity.class);
    ...
    public void onClickSetoran(View v){
        Intent i = new Intent(this,Setoran_HafalanActivity.class);
        startActivity(i);  // Pindah Intent saat memencet CardView yang sudah diberi onClick bernama onClickTopMeny
    }

    public void onClickEdukasi(View v){
        Intent i = new Intent(this,EdukasiActivity.class);
        startActivity(i);  // Pindah Intent saat memencet CardView yang sudah diberi onClick bernama onClickTopMeny
    }

    public void onClickAktifitas(View v){
    ...
    public boolean onOptionsItemSelected(MenuItem item) { //Disini baru membuat menu inflatternya
        switch (item.getItemId()){
            case R.id.about: //Jika yang diklik about maka ke profil activity About
                Intent about = new Intent(this,MyProfileSantriActivity.class);
                startActivity(about);
                break;
