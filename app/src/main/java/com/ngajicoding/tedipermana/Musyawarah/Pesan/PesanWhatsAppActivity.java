package com.ngajicoding.tedipermana.Musyawarah.Pesan;
...
public class PesanWhatsAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pesan_whats_app);
